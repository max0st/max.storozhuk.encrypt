...
public class ExpectedPercentages {
    ...
    public static final String UKRAINIAN_ALPHABET = AlphabetDeterminer.UKRAINIAN_ALPHABET;
    private static final String ENGLISH_ALPHABET = AlphabetDeterminer.ENGLISH_ALPHABET;
